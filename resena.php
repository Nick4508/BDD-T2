    ...
    switch($accion){
        case "Enviar":
            ...
            if (mysqli_num_rows($query_res) > 0) {
                ...
                $query3 = mysqli_prepare($conexion, "INSERT INTO resena_hotel (id_usuario, fecha, opinion, limpieza, servicio, decoracion, camas, id_hotel, promedio) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
                mysqli_stmt_bind_param($query3, "isiiiiis", $id_usuario, $fechaHoy, $txtRese, $txtCaliLim, $txtCaliServ, $txtCaliDec, $txtCaliCama, $id_producto, 0);
